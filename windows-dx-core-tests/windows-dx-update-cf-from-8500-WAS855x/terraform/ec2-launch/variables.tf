...
terraform {
  backend "s3" {
    bucket = "dx-testarea"
    key    = "terraform-status/windows-dx-core-tests/windows-dx-update-cf-from-8500-WAS855x/windows-dx-update-cf-from-8500-WAS855x-local.key"
    region = "us-east-1"
  }
}
