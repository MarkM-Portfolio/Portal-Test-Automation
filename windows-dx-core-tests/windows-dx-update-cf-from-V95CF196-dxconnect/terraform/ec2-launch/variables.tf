...
terraform {
  backend "s3" {
    bucket = "dx-testarea"
    key    = "terraform-status/windows-dx-core-tests/windows-dx-update-cf-from-V95CF196-dxconnect/windows-dx-update-cf-from-V95CF196-dxconnect-local.key"
    region = "us-east-1"
  }
}
