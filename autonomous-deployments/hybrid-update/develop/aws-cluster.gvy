...
pipeline {
    ...
    parameters {
      ...
      string(name: 'UPDATE_CORE_RELEASE_LEVEL', defaultValue: '1', description: 'Update from n to n+UPDATE_CORE_RELEASE_LEVEL', trim: false)
        ...
        stage("Load modules and configuration") {
            steps {
                script {
                    ...
                    env.NAMESPACE = "eks-n${UPDATE_RELEASE_LEVEL}-clstrhyb-dev"
                }
            }
        }
