...
pipeline {
    ...
    parameters {
      ...
      string(name: 'UPDATE_DEPLOYMENT_LEVEL', defaultValue: 'develop',description: 'Updating to the latest master images')
        ...
        stage("Load modules and configuration") {
            steps {
                script {
                    ...
                    env.NAMESPACE = "eks-n${UPDATE_RELEASE_LEVEL}-stdhyb-mstr"
                }
            }
        }
