...
pipeline {
    ...
    stages {
        ...
        stage('Undeploying the application from google gke hybrid environment') {
            steps {
                script {
                    ...
                    buildParams = commonModule.createHybridKubeUnDeployParams(env.NAMESPACE, params.KUBE_FLAVOUR, "false", params.CLUSTER_NAME, params.CLUSTER_REGION, "")
        ...
        stage('Deploying the application in google gke hybrid environment') {
            steps {
                script {
                    buildParams = commonModule.createHybridFreshDeployParams(env.NAMESPACE, params.KUBE_FLAVOUR, params.DEPLOYMENT_LEVEL, DOMAIN_SUFFIX, 0, "false", "false", 0, params.CLUSTER_NAME, params.CLUSTER_REGION, "", params.CONTEXT_ROOT_PATH, params.DX_CORE_HOME_PATH, params.PERSONALIZED_DX_CORE_PATH)
