        ...
        stage("Load modules and configuration") {
            steps {
                script {
                    ...
                    env.NAMESPACE = "gke-clstrhyb-rel"
                }
            }
        }
        ...
        stage('Undeploying the application from google gke hybrid environment') {
            steps {
                script {
                    ...
                    buildParams = commonModule.createHybridKubeUnDeployParams(env.NAMESPACE, params.KUBE_FLAVOUR, commonConfig.COMMON_CLUSTERED_ENV, params.CLUSTER_NAME, params.CLUSTER_REGION, "")
