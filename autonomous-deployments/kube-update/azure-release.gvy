...
pipeline {
    ...
    parameters {
      ...
      string(name: 'KUBE_UPDATE_JOB', defaultValue: 'kube/cloud-update-deploy', description: 'Job which updates the image on AKS',  trim: false)
        ...
        stage("Load modules and configuration") {
            steps {
                script {
                    ...
                    env.NAMESPACE = "aks-${DEPLOYMENT_METHOD}-n${UPDATE_RELEASE_LEVEL}-rel"
                }
            }
        }
