...
## Get parameters
GROOVY_SCRIPT=add-cred-store.groovy
DEFAULT_DATA_FILE=default-creds.txt
MIGRATE_DATA_FILE=migrate-creds.txt
...
mv $SCRIPT_DIR/helpers/$MIGRATE_DATA_FILE /tmp/install_jenkins/$MIGRATE_DATA_FILE
mv $SCRIPT_DIR/helpers/$DEFAULT_DATA_FILE /tmp/install_jenkins/$DEFAULT_DATA_FILE
...
## Set port routing
echo "Set port routing for Jenkins"
