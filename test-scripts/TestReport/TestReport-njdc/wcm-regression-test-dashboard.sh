...
current_run_file="wcm-regression-run.xml"

cd /home/jmeter_user/wcm-perfomance-regression-reports/
...
# java -jar /opt/wcm-perfomance-regression-reports/Saxon-HE-9.5.1-3.jar -o:"$current_run_file" Test_IUT_Master.xml /opt/wcm-perfomance-regression-reports/wtf-run-to-xml.xslt pBuildName="$1"

# insert a line break needed for the read line while loop below
echo '' >> "$current_run_file"

# if there is a running WTF results file
iut_combined_runs_file="onprem_wcm_performance_tests_results.xml"
...
then
    ...
    java -jar /home/jmeter_user/wcm-perfomance-regression-reports/Saxon-HE-9.5.1-3.jar -o:"$2"-dashboard.html "$iut_combined_runs_file" /home/jmeter_user/wcm-perfomance-regression-reports/wcm-dashboard-convert-xml.xslt pWTF="$2"

    # ensure that we have a dashboard dir
    if [ ! -d "/home/jmeter_user/wcm-perfomance-regression-reports/dashboard" ] 
    then
        echo "Directory /home/jmeter_user/wcm-perfomance-regression-reports/dashboard DOES NOT exist, so creating it" 
        cd /home/jmeter_user/wcm-perfomance-regression-reports/
        mkdir dashboard
        cd /home/jmeter_user/wcm-perfomance-regression-reports
    fi
    ...
    cp "$2"-dashboard.html /home/jmeter_user/wcm-perfomance-regression-reports/dashboard/
    cp "$iut_combined_runs_file" /home/jmeter_user/wcm-perfomance-regression-reports/dashboard/"$2"-combined-runs.xml
