...
<xsl:param name="pWTF" select="'PNP Regression'"/>
<xsl:param name="pAverageThresholdValue" select="'.37 seconds'"/>
<xsl:param name="pThroughputThresholdValue" select="'25.8 per seconds'"/>
        ...
        <td>
          <a>
            <xsl:attribute name="href">
              ...
              <xsl:value-of select="'/pandp_test_reports/index.html'"/>
            </xsl:attribute>
            <xsl:value-of select="@buildName"/>
          </a>
        </td>
