...
/opt/IBM/WebSphere/wp_profile/ConfigEngine/./ConfigEngine.sh stop-portal-server -DWasPassword=${WAS_PASSWORD}
...
/opt/IBM/InstallationManager/eclipse/tools/imcl deleteSavedFiles
