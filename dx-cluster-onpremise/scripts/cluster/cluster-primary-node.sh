...
/opt/IBM/WebSphere/wp_profile/ConfigEngine/ConfigEngine.sh  -DSaveParentProperties=true -DparentProperties="/tmp/dx-onpremise/cluster/properties/FederateNode.properties" -DWasPassword=$was_password -DDmgrNodeName=dmgrNode01 -DDmgrCellName=dmgrCell01 -DdmgrProfilePath=/opt/IBM/WebSphere/AppServer/profiles/dmgr01 -DisRemoteDmgr=false add-node -DWasPassword=$was_password
