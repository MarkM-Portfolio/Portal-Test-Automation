...
pipeline { 
    parameters {
        ...
        string(name: 'DB2_REMOVE_JOB', defaultValue: '/CI/hybrid_seeded/onpremise_seeded/db2-destroy', description: 'DB host removal job path',  trim: false)
            ...
            steps {
                script {
                    withCredentials([
                        ...
                        dir("${workspace}/dx-cluster-onpremise/terraform/ec2-dx-onpremise-remove") {
                            configFileProvider([
                        ...
                        dir("${workspace}/dx-cluster-onpremise/terraform/ec2-dx-onpremise-remove") {
                            configFileProvider([
                                ...
                                sh(script: """
                                    ...
                                    ls -lah
                                    printenv
                                    ${workspace}/terraform init -backend-config="key=terraform-status/dx-cluster-onpremise/${REMOTE_SEARCH_INSTANCE_NAME}.key"
