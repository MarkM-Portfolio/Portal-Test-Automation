...
while IFS= read -r line1 && IFS= read -r line2 <&3; do
  curl --header 'Authorization: token a6e1b4891cf73029a9f3b692635e06d3a4d08261' --header 'Accept: application/vnd.github.v3.raw' --remote-name --location $line1 && unzip -qq develop.zip && sudo mv $line2-develop  $line2  &&   rm -rf develop.zip
  echo "File 1: $line1"
  echo "File 2: $line2"
