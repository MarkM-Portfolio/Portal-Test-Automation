...
# Get the ID of the previously created syndication library
...
curl -b subscriberCookie.txt -s  -o Symbol.txt -w "%{http_code}" --location --request GET "http://${SUBSRIBER_IP}:10039/wps/mycontenthandler/!ut/p/wcmrest-v2/search?type=DxSymbol" \
--header 'Accept: application/json' \
--header 'Content-Type: application/json' \
--header 'Cookie: JSESSIONID=000045dibNHXRabRpPXK09BMLJN:-1; LtpaToken2=' \
--data '{}' 
