...
curl -b cookie.txt -s  -o Syndicators.txt -w "%{http_code}" --location --request GET "$SYNDICATOR_WCM_REST/mycontenthandler/!ut/p/wcmrest/Syndication/Syndicators" \
--header 'Accept: application/json' \
--header 'Content-Type: application/json' \
--header 'Cookie: JSESSIONID=000045dibNHXRabRpPXK09BMLJN:-1; LtpaToken2=' \
--data '{}'
...
# curl -b cookie.txt  -o Site.txt -w "%{http_code}" --location --request POST "$SYNDICATOR_WCM_REST/mycontenthandler/!ut/p/digest!CWb11PoiCvMXKblug8zpmg/wcmrest-v2/content-sites/" \
...
# curl -b cookie.txt  -o Page.txt -w "%{http_code}" --location --request POST "$SYNDICATOR_WCM_REST/mycontenthandler/!ut/p/digest!CWb11PoiCvMXKblug8zpmg/wcmrest-v2/content-pages/" \
# --header 'Authorization: Basic d3BzYWRtaW46d3BzYWRtaW4=' \
# --header 'Content-Type: application/json' \
# --data '{
#     "title": {
...
# curl -b cookie.txt -s  -o Symbol.txt -w "%{http_code}" --location --request POST "$SYNDICATOR_WCM_REST/mycontenthandler/!ut/p/digest!CWb11PoiCvMXKblug8zpmg/wcmrest-v2/containers/" \
# --header 'Authorization: Basic d3BzYWRtaW46d3BzYWRtaW4=' \
# --header 'Content-Type: application/json' \
...
curl -b cookie.txt  -o Project.txt -w "%{http_code}" --location --request POST "$SYNDICATOR_WCM_REST/mycontenthandler/wcmrest/Project?mime-type=application/json" \
--header 'Authorization: Basic d3BzYWRtaW46d3BzYWRtaW4=' \
...
curl -b cookie.txt -s  -o Content.txt -w "%{http_code}" --location --request GET "$SYNDICATOR_WCM_REST/mycontenthandler/!ut/p/wcmrest-v2/search?libraryID=$SyndicationLibrary&title=Sample%20Article&type=Content" \
--header 'Accept: application/json' \
--header 'Content-Type: application/json' \
--header 'Cookie: JSESSIONID=000045dibNHXRabRpPXK09BMLJN:-1; LtpaToken2=' \
--data '{}' 
...
curl -b cookie.txt -s  -o ContentTemplate.txt -w "%{http_code}" --location --request GET "$SYNDICATOR_WCM_REST/mycontenthandler/!ut/p/wcmrest-v2/contents/$ContentID" \
--header 'Accept: application/json' \
--header 'Content-Type: application/json' \
--header 'Cookie: JSESSIONID=000045dibNHXRabRpPXK09BMLJN:-1; LtpaToken2=' \
--data '{}' 
...
curl -b cookie.txt  -o DraftContent.txt -w "%{http_code}" --location --request POST "$SYNDICATOR_WCM_REST/mycontenthandler/wcmrest/Content?mime-type=application/json" \
--header 'Authorization: Basic d3BzYWRtaW46d3BzYWRtaW4=' \
--header 'Content-Type: application/atom+xml' \
