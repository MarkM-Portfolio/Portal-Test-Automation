...
if [[ $? -eq 0 && $DOCKER_INSTALLED != "" ]];then
   ...
   docker run -itd --name dxdb2 -e DB2INST1_PASSWORD=$DB2_PASSWORD --privileged=true --add-host=$EC2_INTERNAL_DNS:$EC2_INTERNAL_IP --network=host --hostname=$EC2_INTERNAL_DNS -p 50000:50000 -p 50001:50001 IMAGE_NAME_PLACEHOLDER
