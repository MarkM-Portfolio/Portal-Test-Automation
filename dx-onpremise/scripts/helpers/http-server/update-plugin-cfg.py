...
AdminConfig.modify(pluginId, '[["LogFilename" "/opt/HCL/ihsPlugins/logs/webserver1/http_plugin.log"]]')
AdminConfig.modify(pluginId, '[["PluginInstallRoot" "/opt/HCL/ihsPlugins"]]')
AdminConfig.modify(pluginId, '[["RemoteConfigFilename" "/opt/HCL/ihsPlugins/config/webserver1/plugin-cfg.xml"]]')
AdminConfig.modify(pluginId, '[["RemoteKeyRingFilename" "/opt/HCL/ihsPlugins/config/webserver1/plugin-key.kdb"]]')
...
if isCluster == 'true' :
    ...
    profileConfigPath = '/opt/HCL/AppServer/profiles/dmgr01/config'
else:
    profileConfigPath = '/opt/HCL/wp_profile/config'
